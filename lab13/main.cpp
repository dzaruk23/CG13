...
string vsPath = "C:\\Users\\Dzaruk\\Desktop\\lab13\\lab13\\vertex.shader";
string fsPath = "C:\\Users\\Dzaruk\\Desktop\\lab13\\lab13\\fragment.shader";
...
void draw()
{
	...
	// Перемещаем центр нашей оси координат для того чтобы увидеть вазу
	Matrix_projection = glm::translate(Matrix_projection, vec3(x, y, z));
...
int main(int argc, char** argv)
{
	...
	//! Инициализация
	initGL();
	loadOBJ("C:\\Users\\Dzaruk\\Desktop\\lab13\\lab13\\vase.obj");
